        ...
        <table id="biller-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($biller->id); ?>">
                    ...
                    <?php if($biller->image): ?>
                    <td> <img src="<?php echo e(url('public/images/biller',$biller->image)); ?>" height="80" width="80">
                    </td>
                    <?php else: ?>
                    <td>No Image</td>
                    <?php endif; ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/salepropos/resources/views/biller/index.blade.php ENDPATH**/ ?>